...
public class TrigonometricTests
{
    ...
    [InlineData("1", "0")]
    [InlineData("-1", "1")]
    public void AcosPi_ValidInput_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
    ...
    public void Sin_SpecialAngles_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
    ...
    [InlineData("-1.570796327", "-1")]
    [InlineData("-0.523598776", "-0.5")]
    public void Sin_NegativeAngles_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
        var result = ChiFixed.Sin(input);
    ...
    public void Sin_Periodicity_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
        var result = ChiFixed.Sin(input);
    ...
    public void Cos_SpecialAngles_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
    ...
    public void Cos_Periodicity_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
        var result = ChiFixed.Cos(input);
    ...
    [InlineData("-1.047197551", "0.5")]
    [InlineData("-0.785398163", "0.707106781")]
    public void Cos_NegativeAngles_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
        var result = ChiFixed.Cos(input);
    ...
    [InlineData("-0.785398163", "-1")]
    public void Tan_SpecialAngles_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
    ...
    [Theory]
    [InlineData("3.141592654", "0")]
    public void Tan_Periodicity_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
        var result = ChiFixed.Tan(input);
    ...
    public void Asin_ValidInput_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
    ...
    public void Acos_ValidInput_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
    ...
    [InlineData("-0.5", "-0.463647609")]
    public void Atan_StandardInput_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
    ...
    public void Atan_LargeInput_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
        var result = ChiFixed.Atan(input);
    ...
    [InlineData("-0.5", "-1")]
    public void SinPi_MultiplesOfPi_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
    ...
    [InlineData("2", "1")]
    [InlineData("0.25", "0.707106781")]
    public void CosPi_MultiplesOfPi_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
    ...
    [InlineData("0.25", "1")]
    [InlineData("-0.25", "-1")]
    public void TanPi_MultiplesOfPi_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
    ...
    public void AsinPi_ValidInput_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
    ...
    [InlineData("1", "0.25")]
    [InlineData("-1", "-0.25")]
    public void AtanPi_ValidInput_ReturnsCorrectValue(string inputStr, string expectedStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
    ...
    [Fact]
    public void SinCos_Zero_ReturnsCorrectValues()
    {
    ...
    public void SinCos_SpecialAngles_ReturnsCorrectValues(string inputStr, string expectedSinStr, string expectedCosStr)
    {
        var input = (ChiFixed)decimal.Parse(inputStr, CultureInfo.InvariantCulture);
    ...
    [Fact]
    public void SinCos_Called_HasCorrectTupleNames()
    {
    ...
    public void Atan2_AllQuadrants_ReturnsCorrectAngle(string yStr, string xStr, string expectedStr)
    {
    ...
    public void Atan2_PythagoreanTriples_ReturnsCorrectAngle(string yStr, string xStr, string expectedStr)
    {
        var y = (ChiFixed)decimal.Parse(yStr, CultureInfo.InvariantCulture);
        var x = (ChiFixed)decimal.Parse(xStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
    ...
    [InlineData("-1", "0", "-0.5")]
    [InlineData("0", "-1", "1")]
    public void Atan2Pi_CardinalDirections_ReturnsCorrectFractionOfPi(string yStr, string xStr, string expectedStr)
    {
        var y = (ChiFixed)decimal.Parse(yStr, CultureInfo.InvariantCulture);
        var x = (ChiFixed)decimal.Parse(xStr, CultureInfo.InvariantCulture);
        var expected = (ChiFixed)decimal.Parse(expectedStr, CultureInfo.InvariantCulture);
    ...
    [Fact]
    public void SinCosPi_Zero_ReturnsCorrectValues()
    {
    ...
    [InlineData("0.5", "1", "0")]
    [InlineData("1", "0", "-1")]
    public void SinCosPi_SpecialAngles_ReturnsCorrectValues(string inputStr, string expectedSinStr,
    ...
    [Fact]
    public void SinCosPi_Called_HasCorrectTupleNames()
    {
